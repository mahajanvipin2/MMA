...
public class mainMMA {
    ...
    /*@Test
    public void Step1_DeviceIsRooted() {
        // Do everything when the popup comes "Pay Atttention, device is rooted.". Then click ok.
    }

    @Test void Step2_MMATourClosing() {
        // MMA Tour is showing up, close the tour.
    }*/


    @Test
    public void fun_mehr() throws IOException, BiffException, InterruptedException {
...
/*            if (androidDriver.findElement(By.xpath("/hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.FrameLayout/android.widget.FrameLayout[2]/android.widget.RelativeLayout/android.widget.FrameLayout[1]/android.widget.LinearLayout/android.widget.ScrollView/android.widget.LinearLayout/android.widget.LinearLayout[1]/android.widget.LinearLayout[3]/android.support.v7.widget.RecyclerView/android.widget.LinearLayout['" + h + "']/android.widget.CheckBox")).isEnabled()) {
            ...
            h++;*/
            androidDriver.findElement(By.xpath("//android.support.v7.widget.RecyclerView[contains(@resource-id,'infoflash_settings_recycler_view')]//android.widget.CheckBox[contains(@resource-id,'view_switch_item_option_switch')]['\" + h + \"']")).click();
            h++;
        }
